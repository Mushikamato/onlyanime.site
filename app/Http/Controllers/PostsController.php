...
class PostsController extends Controller
{
    ...
    public function getPost(Request $request)
    {
        ...
        if (Auth::check() && (PostsHelperServiceProvider::hasActiveSub(Auth::user()->id, $post->user->id)
        ...
        if (Auth::check() && ($post->isSubbed || Auth::user()->id == $post->user->id || (getSetting('profiles.allow_users_enabling_open_profiles') && $post->user->open_profile))) {
