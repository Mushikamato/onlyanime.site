<div class="form-group ">
    ...
    {{-- New 18+ content switch --}}
    <div class="card py-3 px-3 mt-3">
        <div class="custom-control custom-switch custom-switch">
           <input type="checkbox" class="custom-control-input" id="show_adult_content" name="show_adult_content" {{ $show_adult_content ? 'checked' : '' }}>
            <label class="custom-control-label" for="show_adult_content">{{__('Show 18+ Content')}}</label>
        </div>
        <div class="mt-2">
            <span>{{__('If enabled, you will see adult (18+) content on the main feed and in reels.')}}</span>
        </div>
    </div>
    {{-- End new 18+ content switch --}}
