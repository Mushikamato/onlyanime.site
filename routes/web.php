...
Route::group(['prefix' => 'admin', 'middleware' => ['jsVars', 'admin']], function () {
    ...
    // START: ADDED ROUTES FOR THE SEEDER TOOL
Route::get('/seeder-tool', 'GenericController@showSeederTool')->name('admin.seeder.index');
Route::post('/seeder-tool', 'GenericController@seedPosts')->name('admin.seeder.seedPosts');
    // END: ADDED ROUTES FOR THE SEEDER TOOL
...
Route::get('/search/featured', ['uses' => 'SearchController@getFeaturedContent', 'as' => 'search.featured']);
